            ...
            <div className="w-full flex-shrink-0 pt-2 xl:w-96 xl:pl-4 xl:pt-0">
              ...
              <div className="mt-8">
                <p className="">
                  ...
                  nemo rerum architecto beatae neque animi ratione possimus, nam
                  consequuntur vero aliquam quisquam aliquid? Corrupti alias est
                  velit ut recusandae vitae totam deleniti autem? Voluptatum qui
                  rerum vitae at dicta consectetur reiciendis hic doloremque eum
                  inventore, temporibus veniam nobis enim recusandae dolore
                  explicabo incidunt perferendis quisquam. Obcaecati, omnis
                  perferendis si.
                </p>
              </div>
              <div className="mt-8">
